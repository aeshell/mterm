...
class MenuColorAction extends MenuBaseAction {
  ...
  MenuColorAction(String text, ImageIcon icon, JTextArea textArea) {
    super(text, icon)
  ...
  void actionPerformed(ActionEvent e) {
    ...
    String[] colors = [ '<html><font color=default>DEFAULT</font></html>',
      ...
      '<html><font color=yellow>YELLOW</font></html>' ] as String[]

    JComboBox<String> bgColor = new JComboBox()
    JComboBox<String> fgColor = new JComboBox()
    for (String c : colors) {
      bgColor.addItem(c)
      fgColor.addItem(c)
    }

    Object[] drops = [ 'BG:', bgColor, 'FG:', fgColor ] as Object[]
